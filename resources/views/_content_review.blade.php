<section id="testimonial-section">
    <div id="testimonial-trigger" class="testimonial text-white parallax" data-stellar-background-ratio="0.5"
        style="background-image: url(asset/img/testimonial-bg.jpg);">
        <div class="cover"></div>
        <!-- Begin page header-->
        ...
        <div class="container">
            <div class="testimonial-inner center-block text-center">
                <div id="owl-testimonial" class="owl-carousel">
                    <div class="item">
                        <blockquote>
                            <p>"Love is put into the dish as a spice to make the dish more delicious. So when we appreciate the effort of the cook, we will feel more appetizing.".</p>
